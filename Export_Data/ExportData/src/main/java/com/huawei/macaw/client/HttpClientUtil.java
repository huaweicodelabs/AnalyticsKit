...
public class HttpClientUtil {
     ...
     * @return result
     */
    public static String doPost(String url, Map<String, String> jsonParams, String charset, Map<String, String> headerMap) {
     ...
     * @throws IOException
     */
    private static String getResult(HttpPost httpPost) throws IOException {
